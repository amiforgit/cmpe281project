...
public class BillingDAO {
	...
	public List<BillingVO> display(String id){
		...
		try{
				...
				ResultSet rs = st.executeQuery("SELECT * from iaasdb.sensor_master where user_id="+id+"");
				while(rs.next()){
...
//					long ms = 10304004543l;
					...
					double price = diff * 0.0000001439964404173661;
