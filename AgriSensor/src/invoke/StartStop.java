...
public class StartStop {
	...
	public void stopSensor(String user_id, String sensor_id) throws InterruptedException {
		...
		else
		{
			...
			String query = "UPDATE `iaasdb`.`sensor_master` SET `sensor_status`='Stopped' WHERE `sensor_id`='"+sensor_id+"';";
